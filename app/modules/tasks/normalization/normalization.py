...
def test_nuclei_parse():
        ...
        with open("/home/lirys/devboxes/devbox-capstone/PycharmProjects/restack_api_rewrite/app/reports/nuclei/1c573c23-b987-4029-b49b-6b73a3c80ab8.json", "r") as f:
...
def test_nuclei_parse_to_sarif():
        nuclei_results = test_nuclei_parse()
        _sarif_rules: list = []
        _sarif_results: list = []
        ...
        with open(f"{PROJECT_ROOT}/app/reports/test_nuclei_sarif.json", "w+") as f:
            f.write(json.dumps(_sarif_report, indent=4))
